...
// Apple Store и Google Play иконки как SVG
          ...
          >
                      ...
                      <div className="mt-10 space-y-4">
                        ...
                        >
                          <div className="flex items-center gap-2 text-white">
                            ...
                            <span className="text-xs font-medium">New: Main Stage starts in 30 min!</span>
                          </div>
                        </motion.div>
                      </div>
                    </div>
            ...
            >
              <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl p-3 flex items-center gap-2">
                ...
                <div className="pr-2">
                  <div className="text-xs font-semibold">Push-уведомления</div>
                  <div className="text-[10px] text-muted-foreground">Не пропусти!</div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white dark:bg-zinc-800 rounded-2xl shadow-xl p-3 flex items-center gap-2">
                ...
                <div className="pr-2">
                  <div className="text-xs font-semibold">Карта фестиваля</div>
                  <div className="text-[10px] text-muted-foreground">Offline доступ</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
                        ...
                        <div className="mt-6 space-y-2">
                          ...
                          <div className="bg-white/30 backdrop-blur-md rounded-lg p-1.5 mt-2">
                            <div className="flex items-center gap-1 text-white">
                              ...
                              <span className="text-[8px] font-medium">Main Stage in 30 min!</span>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center lg:justify-start px-4 sm:px-0">
              ...
              >
                <a href="#" className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-[9px] sm:text-[10px] opacity-80">{t("downloadOn")}</div>
              ...
              >
                <a href="#" className="flex items-center justify-center sm:justify-start gap-2 sm:gap-3">
                  ...
                  <div className="text-left">
                    <div className="text-[9px] sm:text-[10px] opacity-80">{t("getItOn")}</div>
