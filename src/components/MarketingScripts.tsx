...
export async function MarketingScriptsHead() {
  ...
  return (
    <>
      ...
      <Script
        src="https://www.googletagmanager.com/gtag/js?id=G-2CR43QPEEW"
        strategy="afterInteractive"
      />
      ...
      <Script id="ms-clarity" strategy="afterInteractive">
        ...
        })(window, document, "clarity", "script", "wx52z62zrc");`}
      </Script>
    ...
    <>
      ...
      <noscript>
        <img
          ...
          width="1"
          style={{ display: "none" }}
          src="https://www.facebook.com/tr?id=5131761063570173&ev=PageView&noscript=1"
          alt=""
        />
      </noscript>
